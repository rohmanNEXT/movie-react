    ...
    <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-4 sm:p-6 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center space-y-6 pb-2">
          <Link to="/" className="inline-flex items-center gap-3 text-3xl md:text-4xl font-semibold tracking-tighter text-white/90 mb-4 transition-transform hover:scale-105">
        ...
        {!isSubmitted ? (
          ...
          <div className="space-y-2">
            ...
            <button 
              type="submit"
              className="w-full py-2 md:py-2.5 bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-full transition-all apple-shadow active:scale-[0.98] text-xs md:text-sm"
            >
              Kirim Instruksi
            </button>
